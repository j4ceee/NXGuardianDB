        ...
        <fieldset class="basic_info_form">
            ...
            <div class="game_info_cont">
                <div class="game_info_field">
                    ...
                    <input type="text" class="win_dark_input" name="title" id="title" value="<?php echo $game["game_name"] ?>" required>
                </div>

                <div class="game_info_field">
                    <label for="developer">Developer:</label>
                    <input list="developers" class="win_dark_input" name="developer" id="developer" value="<?php echo $game["developer"] ?>" required>
                </div>

                <div class="game_info_field">
                    <label for="release">Release Date:</label>
                    <input type="date" class="win_dark_input" name="release" id="release" value="<?php echo $game["release_date"] ?>" required>
                </div>

                <div class="game_info_field">
                    <label for="imageLink">Image Link (1:1):</label>
                    <input type="url" class="win_dark_input" name="imageLink" id="imageLink" value="<?php echo $game["imageLink"] ?>" required>
                </div>
